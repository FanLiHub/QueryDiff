...
def parse_args():
    ...
    args.add_argument("--pretrained", default='checkpoints/dinov2_vitl14_pretrain.pth', type=str)
    args.add_argument("--converted", default='checkpoints/dinov2_converted.pth',type=str)
